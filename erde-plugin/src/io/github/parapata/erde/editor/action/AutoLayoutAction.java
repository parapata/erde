...
import io.github.parapata.erde.editor.diagram.editpart.AbstractErdeEntityEditPart;
import io.github.parapata.erde.editor.diagram.editpart.command.LayoutCommand;
...
public class AutoLayoutAction extends Action implements IErdeAction {
    ...
    public void run() {
        ...
        for (Object obj : models) {
            if (obj instanceof AbstractErdeEntityEditPart) {
                AbstractErdeEntityEditPart editPart = (AbstractErdeEntityEditPart) obj;
