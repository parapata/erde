...
import io.github.parapata.erde.generate.excel.ColumnData;
import io.github.parapata.erde.generate.excel.ExcelGen;
import io.github.parapata.erde.generate.excel.TableData;
...
public class ExcelWriterTask implements IRunnableWithProgress {
    ...
    public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
        try {
            ...
            new ExcelGen().export(outFile, data);
            monitor.worked(1);
        } finally {
            monitor.done();
        }
