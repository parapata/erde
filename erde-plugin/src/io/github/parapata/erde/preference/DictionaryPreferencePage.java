...
public class DictionaryPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    protected Control createContents(Composite parent) {
        ...
        models = NameConverter.loadFromPreferenceStore(ErdePlugin.getDefault().getPreferenceStore());
    ...
    public boolean performOk() {
        NameConverter.saveToPreferenceStore(ErdePlugin.getDefault().getPreferenceStore(), models);
        return true;
    }
