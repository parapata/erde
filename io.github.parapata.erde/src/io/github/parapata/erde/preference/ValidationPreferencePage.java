...
public class ValidationPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    private static final String[][] VALIDATION_LEVELS = new String[][] {
            { LABEL_WARNING.getValue(), ErdePlugin.LEVEL_WARNING },
            { LABEL_ERROR.getValue(), ErdePlugin.LEVEL_ERROR },
            { LABEL_IGNORE.getValue(), ErdePlugin.LEVEL_IGNORE }, };

    public ValidationPreferencePage() {
        super(GRID);
        setPreferenceStore(ErdePlugin.getDefault().getPreferenceStore());
    }
