...
public enum Resource {
    ...
    /** key:wizard.new.erde.dialog.title. */
    WIZARD_NEW_ERDE_DIALOG_TITLE("wizard.new.erde.dialog.title"),
    /** key:wizard.new.erde.page.description. */
    WIZARD_NEW_ERDE_PAGE_DESCRIPTION("wizard.new.erde.page.description"),
    /** key:wizard.new.erde.page.title. */
    WIZARD_NEW_ERDE_PAGE_TITLE("wizard.new.erde.page.title"),
    ...
    /** key:error.erde.extension. */
    ERROR_ERDE_EXTENSION("error.erde.extension"),
