...
public class SQLConfiguration extends SourceViewerConfiguration {
    ...
    private RuleBasedScanner getCommentScanner() {
        ...
        EditorColorProvider colorProvider = ErdePlugin.getDefault().getEditorColorProvider();
        scanner.setDefaultReturnToken(
                colorProvider.getToken(ErdePreferenceKey.COLOR_COMMENT));
        return scanner;
    }
    ...
    private RuleBasedScanner getStringScanner() {
        ...
        EditorColorProvider colorProvider = ErdePlugin.getDefault().getEditorColorProvider();
        scanner.setDefaultReturnToken(
                colorProvider.getToken(ErdePreferenceKey.COLOR_STRING));
        return scanner;
    }
