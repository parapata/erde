...
/**
 * The outline page of the {@link ErdeDiagramEditor}.
 *
 * @author modified by parapata
 */
public class ErdeDiagramOutlinePage extends ContentOutlinePage {
    ...
    public ErdeDiagramOutlinePage(GraphicalViewer viewer, EditDomain domain, RootModel root,
    ...
    public static void setFilterText(String filterText) {
        ErdeDiagramOutlinePage.filterText = StringUtils.defaultString(filterText);
    }
