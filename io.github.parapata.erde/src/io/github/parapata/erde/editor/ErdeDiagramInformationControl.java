...
/**
 * ErdeDiagramInformationControl.
 *
 * @author modified by parapata
 */
public class ErdeDiagramInformationControl extends AbstractInformationControl {
    ...
    public ErdeDiagramInformationControl(Shell parentShell, GraphicalViewer graphicalViewer) {
        super(parentShell, true);
        this.graphicalViewer = graphicalViewer;
        this.modelEditor = new ModelEditor(graphicalViewer, false);

        ErdeDiagramOutlinePage.setFilterText("");
    ...
    protected void createContent(Composite parent) {
        ...
        search.addModifyListener(listener -> {
            ...
            ErdeDiagramOutlinePage.setFilterText(filterText);
            ...
            if (StringUtils.isNotEmpty(filterText)) {
                ...
                List<BaseEntityModel> tables = (List<BaseEntityModel>) folder.getChildren();
