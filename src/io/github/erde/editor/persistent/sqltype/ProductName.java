...
public enum ProductName {
    ...
    HSQLDB("HSQLDB"), @XmlEnumValue("DB2")
    DB_2("DB2"), @XmlEnumValue("PostgreSQL")
    POSTGRE_SQL("PostgreSQL"), @XmlEnumValue("MySQL")
    MY_SQL("MySQL"), @XmlEnumValue("H2")
    H_2("H2"), MSSQL("MSSQL"), @XmlEnumValue("Oracle")
    ORACLE("Oracle"), @XmlEnumValue("Other")
    OTHER("Other");
